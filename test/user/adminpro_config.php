...
$globalConfig['dbase']="usermgmt"; // Your MySQL Database name
...
**********************************************************************************
*/
$globalConfig['inactiveMin']="20"; // The time in minutes to force new login, if account has been inactive
$globalConfig['loginUrl']="login.html"; // The URL of the login page
$globalConfig['logoutUrl']="logout.html"; // The URL of the logout page
/*
...
$globalConfig['errorPageH1']="NOT AUTHORIZED!";
$globalConfig['errorPageLink']="Click to login";
$globalConfig['errorNoCookies']="YOU MUST ACCEPT COOKIES TO PROCCED!";
$globalConfig['errorNoLogin']="PLEASE LOGIN FIRST TO VIEW THIS PAGE!";
$globalConfig['errorInvalid']="INVALID USERNAME OR PASSWORD!";
