...
<body>
	...
	if(mysql_num_rows($result)>0){
		...
		echo("<tr><td colspan='2'></td><td colspan='2'></td><td colspan='3'></td><td><input type='submit' value='save' name='showfront' /><td><input type='submit' value='save' name='status' /></td><td><input type='button' value='delete' name='delete' onClick='deleteProducts(105)'/></td></tr>");
		echo("</table>");
